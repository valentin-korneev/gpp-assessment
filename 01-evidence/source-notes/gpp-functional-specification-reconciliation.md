# Reconciliation: GPP functional specification source family
...
## Внутренняя metadata против filenames

Оба файла внутри содержат одинаковую идентификацию документа:

- title: `HÖKUMƏT ÖDƏNİŞ PORTALI - SİSTEMİN FUNKSİONAL TƏSVİRİ`;
- document id: `GPP_System Functional Specification_v001`;
- version history: `0.01`;
- date: `05.05.2023`;
- history note: initial version.
...
- configuration fields participant organizations;
- payment/service type configuration;
- identification type configuration;
- service fee tariff configuration.

Shared content не создает параллельные facts на каждый файл.

## Значимые delta

| Область | DOCX / filename v005 | PDF / filename v006 | Handling |
|---|---|---|---|
...
## Stakeholder clarification после /questions
